...
char catagories[][30]={"Rings", "Ear Rings", "Ganthan", "Bracelets", "Chain", "Mangalsutra", "Jewellery Set", "Gems"};
...
printf("\tSanskar Pandit - Email id: codewithsanskar@gmail.com ");
printf("\n\t\t\tYoutube Channel : Code With Sanskar");
...
printf("Enter Item's code to be edit:");
...
//visit code-projects.org for more Free Projects
